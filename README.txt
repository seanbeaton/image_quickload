A sandbox for a image slow/lazy loading module. Provides a page for configuration of image style pairs. If a preload image style is provided for a given main image style, the preload one will be loaded first, then replaced with the main image style once the image is fully loaded and in the viewport.
